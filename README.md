...
EspoCRM was explored using the online demo environment. Screenshots of the login page, dashboard, contacts module, leads module, and analytics page were collected. The installation experience, features, and overall usability were also evaluated.

See crm_research.md for the full evaluation.
...
Five prompts used during the research process were documented along with explanations of why each prompt was useful.

See prompts_used.md for details.
